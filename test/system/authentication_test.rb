...
class AuthenticationTest < ApplicationSystemTestCase
  test "user can create account with name, sign out, and sign in again" do
    ...
    assert page.has_selector?("h1", text: "Rails Template"), "Should be on home page with 'Rails Template' heading"
    ...
    assert page.has_selector?("h1", text: "Rails Template"), "Should be back on home page after sign in"
